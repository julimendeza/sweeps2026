...
.c-on   { background: rgba(245,158,11,.2);  border-color: rgba(245,158,11,.55); color: #fbbf24; }
...
.c-off:hover { background: rgba(255,255,255,.1); border-color: rgba(255,255,255,.22); color: rgba(255,255,255,.85); }
.c-on:hover  { background: rgba(245,158,11,.3); }
